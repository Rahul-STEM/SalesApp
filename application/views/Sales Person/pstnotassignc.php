                                ...
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Potential/Non Potential Partner</th>
                                            <th>BD Name</th>
                                            <th>Company ID</th>
                                            <th>Company Name</th>
                                            <th>Total Logs</th>	
                                    ...
                                    <tr>
                                         <td><?=$i?></td>
                                         <th><a href="<?=base_url();?>Menu/PotentialPartner/<?=$cid?>/<?=$code?>">Click</a></th>
                                         <th><a href="<?=base_url();?>Menu/NonPotentialPartner/<?=$cid?>/<?=$code?>">Click</a></th>
                                         <th><?php if($potentialp=='yes'){ echo 'Potential Partner';}elseif($potentialp=='no'){ echo 'Non Potential Partner';}else{echo 'Not Updated';?><?php } ?></th>
                                         <td><?=$user['name']?></td>
                                         <td><?=$cd[0]->id?></td>
