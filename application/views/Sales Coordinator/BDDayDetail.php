...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="card">
              ...
              <?php 
echo $admid;
$mdata = $this->Menu_model->get_BDdaydbyad($admid,$tdate,$code);
// echo "<pre>";
// print_r($mdata);
// die;
?>
                            ...
                            <div class="table-responsive">     
                                 <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                         <td><?=$i?></td>
                                         <td><?=$dt->bdname?></td>
                                         <td><?php if($dt->wffo==1){echo 'Work From Office';}if($dt->wffo==2){echo 'Work From Field';}if($dt->wffo==3){echo 'Work From Field+Office';}?></td>
                                         <td><?=$dt->start?></td>
                                         <td><a href="<?=base_url();?><?=$dt->usimg?>"><i class="fa fa-image" style="font-size:36px"></i></a></td>
                                         ...
                                         <td><?=$dt->close?></td>
                                         <td><a href="<?=base_url();?><?=$dt->ucimg?>"><i class="fa fa-image" style="font-size:36px"></i></a></td>
