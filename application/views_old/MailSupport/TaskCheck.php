       ...
       <div class="row p-3">
           <div class="col-sm col-md-12 col-lg-12 m-auto">
              ...
              <div class="card-body box-profile">
                  ...
                  $bdid=$this->Menu_model->get_pstbyaid('45');
                  foreach($bdid as $bd){
                      $bdname = $bd->name;
                      $bduid = $bd->user_id;
                  ?>
                  <center><h5><?=$bdname?></h5></center><br>
                  <center><h5>(Total Task: | Task Early : | Task Late : | Task Today Assign | Task a day beforeAssign : )</center><br>
                  ...
                  ?>
                        ...
                        <tr>
                            <td><?=$i++?></td>
                            <td><a target="_blank" href="<?=base_url();?>Menu/CompanyDetails/<?=$md->cmpid?>"><?=$md->compname?></a></td>
                            <td><?=$md->aname?></td>
                            <td><?=$plandt?></td>
                            <td><?=$startm?></td>
                            <td><?=$closem?></td>
                        ...
                        <?php } ?>
                         ...
                         <?php $taskaypy = $this->Menu_model->get_TaskCheckanpn($bduid,$tdate);
                  if($taskaypy){
                  ?>
