    ...
    <div class="card">
              ...
              <div class="card-body">
                  <div class="container body-content">
                    <form class="p-3" method="POST" action="TeamDetail">
                        <input type="date" name="tdate" class="mr-2">
                            ...
                            <div class="table-responsive">     
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                         <td><?=$i?></td>
                                         <td><?=$dt->bdname?></td>
                                         <td><?=$start=$dt->start?></td>
                                         <td><?php if($dt->usimg=='uploads/day/'){echo 'NO Image';}else{?><a href="<?=base_url();?><?=$dt->usimg?>" target="_blank"><i class="fa fa-image" style="font-size:36px"></i></a><?php }?></td>
                                         ...
                                         <td><?=$close=$dt->close?></td>
                                         <td><?php if($dt->usimg=='uploads/day/'){echo 'NO Image';}else{?><a href="<?=base_url();?><?=$dt->ucimg?>" target="_blank"><i class="fa fa-image" style="font-size:36px"></i></a><?php }?></td>
