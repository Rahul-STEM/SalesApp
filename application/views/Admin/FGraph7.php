      ...
      <div class="container-fluid">
          ...
          foreach($status as $st){ 
            ...
            foreach($swtc as $sw){
               ?>
               <?=$st->name?>
               <b><a href="<?=base_url();?>Menu/FGraph7/<?= $st->id?>"><?=$sw->a?>( <?=$sw->cont?>)</a>
               <b><a href="<?=base_url();?>Menu/FGraph7/<?= $st->id?>"><?=$sw->b?>( <?=$sw->cont?>)</a>
               <b><a href="<?=base_url();?>Menu/FGraph7/<?= $st->id?>"><?=$sw->c?>( <?=$sw->cont?>)</a>
               <b><a href="<?=base_url();?>Menu/FGraph7/<?= $st->id?>"><?=$sw->d?>( <?=$sw->cont?>)</a>
               <b><a href="<?=base_url();?>Menu/FGraph7/<?= $st->id?>"><?=$sw->e?>( <?=$sw->cont?>)</a>
               <b><a href="<?=base_url();?>Menu/FGraph7/<?= $st->id?>"><?=$sw->f?>( <?=$sw->cont?>)</a>
               <b><a href="<?=base_url();?>Menu/FGraph7/<?= $st->id?>"><?=$sw->g?>( <?=$sw->cont?>)</a>
               <b><a href="<?=base_url();?>Menu/FGraph7/<?= $st->id?>"><?=$sw->h?>( <?=$sw->cont?>)</a>
               <b><a href="<?=base_url();?>Menu/FGraph7/<?= $st->id?>("><?=$sw->i?> <?=$sw->cont?>)</a>
               <b><a href="<?=base_url();?>Menu/FGraph7/<?= $st->id?>"><?=$sw->j?>( <?=$sw->cont?>)</a>
               <b><a href="<?=base_url();?>Menu/FGraph7/<?= $st->id?>"><?=$sw->k?>( <?=$sw->cont?>)</a>
               </b>
