                                ...
                                <div class="pdf-viwer">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            $scname=$this->Menu_model->final_scon1($admid,$sd,$ed,0); 
                                            $bddetail=$this->Menu_model->final_scon4($admid,$sd,$ed,0); 
                                    ...
                                    <tbody>
                                        ...
                                        $scname=$this->Menu_model->final_scon1($admid,$sd,$ed,0);
                                            ...
                                            $ssid = $secondS[0]->id;
                                        ?>      
                                        <td><a href="<?=base_url();?>Menu/FinalSConversion/<?=$bdid?>/<?=$sd?>/<?=$ed?>/<?=$fsid?>/<?=$ssid?>">
                                            <?=$this->Menu_model->final_scon2($bdid,$sd,$ed,0,$fsid,$ssid);?>
                                            </a></td> 
                                        <?php } ?>  
