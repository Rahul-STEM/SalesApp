    ...
    <section class="content">
      <div class="container-fluid">
          <div class="card col-12  p-3 text-center">
              <center><h5>Office/On Field Hour action Wise</h5></center><hr>
            ...
            datasets: [
                {
                    ...
                    data: [
                        ...
                        $task = $this->Menu_model->get_tasktypeupdate($uid,$sd,$ed,$acid);
                        foreach($task as $ts){
                        ?>
                        <?=$ts->cont?>,
                        <?php }} ?>],
                ...
                $action = $this->Menu_model->get_action(); $i=1; foreach($action as $ac){ $acid = $ac->id;
                $taskstatus = $this->Menu_model->get_tasktypeupdatereview($uid,$sd,$ed,$acid);foreach($taskstatus as $tasks){
