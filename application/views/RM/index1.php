      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-sm-12">
            ...
            <div class="small-box bg-light text-secondary">
              <div class="inner">
                  <?php $ttswwork = $this->Menu_model->new_pstttswplan($uid,$tdate,0);
                  foreach($ttswwork as $tw){?>
        ...
        <!-- /.row -->
          ...
          <div class="col-lg-3 col-md-6 col-sm-12">
            ...
            <div class="small-box bg-light text-secondary">
              <div class="inner">
                  <?php $sca = $this->Menu_model->final_myscon1($uid,$tdate,$tdate,0); ?>
                <center><h5>Today's My Status Conversion</h5></center><hr>
                    <?php  foreach($sca as $scid){
                        $string = $scid->scname;
                        $parts = explode(" -to- ", $string);
                        $firstS = $parts[0];
                        ...
                        $secondS = $this->Menu_model->get_statusbyname($secondS);
                        $ssid = $secondS[0]->id; ?>
                        <a href="FinalMySConversion/<?=$uid?>/<?=$tdate?>/<?=$tdate?>/<?=$fsid?>/<?=$ssid?>">
                           <?=$string?> - <b><?=$this->Menu_model->final_myscon2($uid,$tdate,$tdate,0,$fsid,$ssid);?></b><hr>
                        </a>
                    <?php } ?>
                </div>
              <div class="icon">
              ...
              <a href="MySConversion" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
