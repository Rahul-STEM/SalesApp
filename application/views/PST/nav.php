    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!--<li class="nav-item">
            <a href="<?=base_url();?>Menu/NextDayPlanner" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>Next Day Planner</p>
            </a>
          </li>-->
          <li class="nav-item">
            <a href="<?=base_url();?>Menu/DailyTeamCoordination" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>Daily Team Coordination</p>
            </a>
          </li>
          <li class="nav-item">
         ...
         $current_date = date('Y-m-d');
          $days = $this->Menu_model->get_daystarted($uid,$tdate); if($days){?>
          <li class="nav-item">
