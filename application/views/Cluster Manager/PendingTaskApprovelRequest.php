...
<html lang="en">
  <head>
    ...
    <title>Pending Task Approvel Request | STEM APP| WebAPP</title>
          ...
          <div class="container-fluid">
            ...
            <div class="card p-2 bg-primary">
              <div class="row">
                ...
                <div class="col-md-4">
                  <form class="setpaldate" action="<?=base_url();?>Menu/PendingTaskApprovelRequest" method="post">
                ...
                <div class="card card-primary card-outline">
                  <div class="card-body box-profile">
                    <div class="bg-warning colapsboxsha text-center mt-2 mb-2">
                      <h3><i>Todays Pending Task Approvel Request</i></h3>
                    </div>
                    <?php
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <div>
                                      <p><a href="<?=base_url();?>Menu/TodaysPendingTaskapprove/<?= $data->tid?>/Approve" class="btn btn-success mr-2" onclick="return confirm('Are you sure you want to Approved id?');" >Approve</a></p>
                                      <p><button type="button" class="btn btn-primary"  onclick="Reject(<?= $j ?>,<?= $data->tid?>,'Reject')">Reject</button></p>
                                    </div>
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="<?=base_url();?>Menu/TodaysPendingsTaskRequestReject" method="post" >
