                    ...
                    <?php 
                      ...
                      <?php 
                        ...
                        if($type_id ==  13 || $type_id == 4){
                          ...
                          <?php 
                            if($type_id ==13){
                              $tooltips = "There has been no activity or progress on any of the tasks related to the top client company, for the last [8/15] days."; //Added by Manasvi
                        ...
                        //  $impcomp ['Need Your Attention']= 0;
                         ...
                         <?php if($type_id ==13 || $type_id ==4){ 
                          if($type_id ==13){
                            $tooltips = "Auto assigned call task, MOM check task"; //Added by Manasvi
