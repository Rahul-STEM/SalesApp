                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <center>
                                <h5>AYPY/AYPN/ANPN Funnel Analysis</h5>
                            </center>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select rounded-0" name="purpose" id="purpose" required>
                                                <option value="">Select Type</option>
...
<script>
    ...
    function drawChart() {
        ...
        <?php
            ...
            $currentDate = new DateTime($edate);
            ...
            for($month = $monthNumber; $month <= 12; $month++) {
