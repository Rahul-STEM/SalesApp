...
<html lang="en">
    ...
    <head>
        ...
        .cat1::after,.cat2::after,.cat3::after,.cat4::after,.cat5::after,.cat6::after,.cat7::after,.cat8::after{content:'';position:absolute;top:6px;left:6px;right:6px;bottom:6px;display:block}.cat1 a,.cat2 a,.cat3 a,.cat4 a,.cat5 a,.cat6 a,.cat8 a{text-decoration:none;z-index:10}.scrollme{overflow-x:auto}.mainBlock{margin-top:10px;padding:10px;border-radius:5px;min-height:80px;min-width:150px;display:flex;align-items:center;justify-content:center;transition:.5s;position:relative}.mainBlock.contact{min-width:400px;display:block}.cat1::after{background:0 0;border:1px solid #1ab6a9}.cat1:hover::after,.cat2:hover::after,.cat3:hover::after,.cat4:hover::after,.cat5:hover::after,.cat6:hover::after,.cat7:hover::after,.cat8:hover::after{border-color:#fff;color:#fff}.cat1:hover{background:#1ab6a9!important}.cat1{background:#effaf8!important}.cat1 a{color:#1ab6a9;}.cat2::after{background:0 0;border:1px solid #f06378}.cat2:hover{background:#f06378!important}.cat2{background:#fef2f4!important}.cat2 a{color:#f06378}.cat3::after{background:0 0;border:1px solid #f8b81f}.cat3:hover{background:#f8b81f!important}.cat3{background:#fffaef!important}.cat3 a{color:#f8b81f}.cat4::after{background:0 0;border:1px solid #0ecd73}.cat4:hover{background:#0ecd73!important}.cat4{background:#eefbf5!important}.cat4 a{color:#0ecd73}.cat5::after{background:0 0;border:1px solid #8e56ff}.cat5:hover{background:#8e56ff!important}.cat5{background:#f7f3ff!important}.cat5 a{color:#8e56ff}.cat6::after{background:0 0;border:1px solid #f8941f}.cat6:hover{background:#f8941f!important}.cat6{background:#fff7ef!important}.cat6 a{color:#f8941f}.cat7::after{background:0 0;border:1px solid #48c5fa}.cat7:hover{background:#48c5fa!important}.cat7{background:#f1fbff!important}.cat8::after{background:0 0;border:1px solid #f92596}.cat8:hover{background:#f92596!important}.cat8{background:#fff0f8!important}.cat8 a{color:#f92596}.mainBlock:hover{box-shadow:0 0 5px #aaa;background-image:linear-gradient(0deg,#fff,#ffffffe0),url(../img/backGround/landing-banner1.png);background-attachment:fixed;background-size:100%;transform:scale(1.001);background-position:center;-webkit-animation:15s linear forwards serviceBgAnim;-o-animation:15s linear forwards serviceBgAnim;animation:15s linear forwards serviceBgAnim}.mainBlock:hover>a{color:#fff !important;}.mainBlock:hover{color:#fff !important;}.mainBlock a h5{font-size:14px;margin:0}

        .cat1.contactdt::after,.cat2.contactdt::after,.cat3.contactdt::after,.cat4.contactdt::after,.cat5.contactdt::after,.cat6.contactdt::after,.cat7.contactdt::after,.cat8.contactdt::after{content:'';position:absolute;top:0;left:0;right:0;bottom:0;display:none;}
        ...
        .mainBlock table h5{font-size:14px;margin:0}
                                    ...
                                    <div class="card-body box-profile">
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                            ...
                                                            <td><?php $mbd = $this->Menu_model->get_userbyid($mainbd);echo $mbd[0]->name?></td>
                                                            ...
                                                            <td><?php if($apst){$apst = $this->Menu_model->get_userbyid($apst);echo $apst[0]->name;}else{echo '';}?></td>
                                    ...
                                    <style>
                                                ...
                                                <?php foreach($init as $in){ ?>
                                                              ...
                                                              <div class="col">
                                                                    ...
                                                                    <td><h5><?= $this->Menu_model->get_statusbyid($in->cstatus)[0]->name; ?></h5></td>

                                                                                    </tr>

                                                                                    <tr>

                                                                                            <td><h5>Topspender</h5></td>

                                                                    <td><h5><?=$in->topspender?></h5></td>

                                                                                    </tr>

                                                                                    <tr>

                                                                                            <td><h5>Upsell Client</h5></td>

                                                                    <td><h5><?=$in->upsell_client?></h5></td>

                                                                                    </tr>

                                                                                    <tr>

                                                                                            <td><h5>Focus Funnel</h5></td>

                                                                    <td><h5><?=$in->focus_funnel?></h5></td>

                                                                                    </tr>

                                                                                    <tr>

                                                                                            <td><h5>Expected Revenue</h5></td>

                                                                    <td><h5><?=$in->exrevenue?> (₹)</h5></td>

                                                                                    </tr>

                                                                                    <tr>

                                                                                            <td><h5>Virtual Meeting</h5></td>

                                                                    <td><h5><?=$in->vmeeting?></h5></td>

                                                                                    </tr>

                                                                                    <tr>

                                                                                            <td><h5>Focus Positive</h5></td>

                                                                    <td><h5><?=$in->focuspositive?></h5></td>

                                                                                    </tr>

                                                                                    <tr>

                                                                                            <td><h5>interventions</h5></td>

                                                                    <td><h5><?= $this->Menu_model->get_userbyid($in->interventions)[0]->name ?></h5></td>

                                                                                    </tr>

                                                                                    <tr>

                                                                                            <td><h5>Cluster Name</h5></td>

                                                                    <td><h5><?=$this->Menu_model->getClusterByid($in->cluster_id)[0]->clustername?></h5></td>
                                ...
                                <!-- /.col -->
                                          ...
                                          <div class="col-sm col-lg-4 showdata">
                                                ...
                                                <?php
                                                                ...
                                                                $contactperson=$d->contactperson;$phoneno=$d->phoneno;
