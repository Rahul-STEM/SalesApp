                ...
                <div class="row no-gutters">
                    <div class="col-12 col-md-12 mb-12 m-3">
                        <center><h6>Task Detail</h6>
                            ...
                            <h6>Last Task Remark : <?=$ttbl[0]->remarks?></h6>
                        </center><hr>
                        <h6><?=$cd[0]->compname?></h6>
                        <?php foreach($ccd as $d){
                            $contactperson=$d->contactperson;$phoneno=$d->phoneno;$emailid=$d->emailid;$designation=$d->designation;?>
...
<!-- <div id="add_whatsapp" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-standard-title" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div clavss="card card-form col-md-12">
                    <div class="row no-gutters">
                        <div class="col-lg-12 card-form__body card-body">
                    </div>
                    <!--<div>
