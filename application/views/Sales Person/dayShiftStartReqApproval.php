...
<html lang="en">
  <head>
    ...
    <title>Day Start Request | STEM APP| WebAPP</title>
                ...
                <div class="card card-primary card-outline">
                  <div class="card-body box-profile">
                    <div class="bg-warning colapsboxsha text-center mt-2 mb-2">
                      <h3><i>Todays Late Day Start Approval Request</i></h3>
                    </div>
                    <?php
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <div>
                                      <p><a href="<?=base_url();?>Menu/LateDayStartapprove/<?= $data->id?>/1" class="btn btn-success mr-2" onclick="return confirm('Are you sure you want to Approved id?');" >Approve</a></p>
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="<?=base_url();?>Menu/dayshiftReject" method="post" >
