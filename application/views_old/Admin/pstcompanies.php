                    ...
                    <div class="card card-form col-md-12">
                       <div class="card-header bg-info">Add Delete Remark</div>
                        <div class="col-lg-12 card-body">
                           ...
                           <textarea rows="10" name="dremark" class="form-control" required></textarea><hr>
                           <button type="submit" class="btn btn-primary mt-3" onclick="this.form.submit(); this.disabled = true;" required>Submit</button>
                           </form>
                        </div>
