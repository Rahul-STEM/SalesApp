      ...
      <div class="container-fluid">
        ...
        <div class="justify-content-center col-lg-4 col-sm m-auto p-3">
             <div class="card custom-card">
                 <?=form_open('Menu/TaskPlanner/'.$adate)?><input type="date" class="form-control" name="adate" value="<?=$adate?>" required=""><input type="submit" value="Set Date"></form>
               <hr>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card mt-3 p-3">
                            ...
                            <div class="col-md-12 col-sm" id="ScheduledBox">
                                   ...
                                   <input type="time" name="tasktimeplan" min="10:00" max="19:00" class="form-control">
