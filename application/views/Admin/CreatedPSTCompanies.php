                                ...
                                <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        foreach($mdata as $dt){
                                            ...
                                            if($mainbd){$bdname=$this->Menu_model->get_userbyid($mainbd);$bdname=$bdname[0]->name;}
                                            else{$bdname='';}
                                        ?>
                                    <tr>
                                         <td><?=$i?></td>
                                         ...
                                         <td><?=$cd[0]->address?></td>
                                         <td><?=$cd[0]->website?></td>
                                         <td><?php if(isset($cd[0]->partnerType_id)){echo $cd[0]->partnerType_id;}?></td>
                                         <td><?php if(isset($cd[0]->focus_funnel)){echo $cd[0]->focus_funnel;}?></td>
                                         <td><?php if(isset($cd[0]->upsell_client)){echo $cd[0]->upsell_client;}?></td>
                                         <td><?=$contactperson?></td>
                                         <td><?=$phoneno?></td>
                                         <td><?=$emailid?></td>
                                         <td><?=$designation?></td>
