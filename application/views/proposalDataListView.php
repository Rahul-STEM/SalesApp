                ...
                <div class="page-header">
                  <fieldset>
                    ...
                    <div class="table-responsive">
                      <div class="table-responsive">
                        <div class="pdf-viwer">
                            <h4><?php echo $username; ?>'s Achieved Data Between <?php echo $sdate;?> And <?php echo $edate;?>
                            </h4>
                          <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                              <?php $i=1;
                            //   echo "<pre>";print_r($prospective_achieved);exit;
                            
                              foreach($prospective_achieved as $dt){
