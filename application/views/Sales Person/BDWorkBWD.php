...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content-header -->
<form class="p-3" method="POST" action="<?=base_url();?>/Menu/BDWorkBWD">
    ...
    <select class="ml-2" name="option" id="option">
        <option>All</option>
        <option>Focus Funnel</option>
        <option>Upsell Client</option>
        <option>Key Client</option>
        <option>Positive Key Client</option>
        <option>Priority Calling</option>
