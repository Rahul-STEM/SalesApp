                            ...
                            <div class="table-responsive">
                                <div class="pdf-viwer">
                                    ...
                                    //  print_r($bd);
                                        ...
                                        if($numberDays<6){   
                                        if($fmeet==0*$numberDays){$remark='Bad performance';$color = 'text-danger';}elseif($fmeet<=$numberDays){$remark='Average Performance';$color = 'text-warning';}else{$remark='Good Performance';$color = 'text-success';}
                                        }}
                                    ...
                                    <tr>
                                        <td><?=$i?></td>
                                        <td><?=$bdname?></td>
                                        <td><a href='<?=base_url();?>/Menu/TBMD/4/<?=$bdid?>/<?=$sd?>/<?=$ed?>'><?=$tt?></a></td>
                                        <td><a href='<?=base_url();?>/Menu/TBMDFRP/5/<?=$sd?>/<?=$ed?>/<?=$bdid?>'><?=$rpm?></a></td>
                                        <td><a href='<?=base_url();?>/Menu/TBMDFRP/10/<?=$sd?>/<?=$ed?>/<?=$bdid?>'><?=$fmeet?></a></td>
                                        <td><a href='<?=base_url();?>/Menu/TBMDFRP/11/<?=$sd?>/<?=$ed?>/<?=$bdid?>'><?=$rmeet?></a></td>
