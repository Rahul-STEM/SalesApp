                            ...
                            <div class="table-responsive">
                                <div class="pdf-viwer">
                                    ...
                                    <thead>
                                        <tr>
                                            <th>Date</th>
                                            <?php $scname=$this->Menu_model->final_pstscon1($uid,$sd,$ed,0); foreach($scname as $sc1){?>
                                            <th><?=$sc1->scname?></th>
                                            <?php } ?>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td><a href="FinalPSTSC/<?=$sd?>/<?=$ed?>"><?=$sd?> to <?=$ed?></a></td>
                                        ...
                                        <td>
                                            <a href="FinalPSTSConversion/<?=$uid?>/<?=$sd?>/<?=$ed?>/<?=$fsid?>/<?=$ssid?>">
                                            <?=$this->Menu_model->final_pstscon2($uid,$sd,$ed,0,$fsid,$ssid);?>
                                            </a>
                                        </td>        
