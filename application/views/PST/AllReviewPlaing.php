    ...
    <div class="row p-3">
                ...
                <div class="card-body box-profile">
                    ...
                    <form action="<?=base_url();?>Menu/startreview" method="post">
                        <div class="was-validated">
                            ...
                            <div class="form-group text-center">
                                <button type="submit" class="btn btn-success" onclick="this.form.submit(); this.disabled = true;">Start <?=$rev->reviewtype?></button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="col-sm col-md-6 col-lg-6 m-auto">
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-4">
                                <select class="form-control" id="categories" name="categories" required="">
                                    ...
                                    <option value="pkclient">Potential key Client</option>
                                </select>
                                <div class="invalid-feedback">Please Create Plan First.</div>
                                <div class="valid-feedback">Looks good!</div>
                            </div>
                         ...
                         <div class="form-group">
                          ...
                          <select id="partnertype_select" class="form-control" name="partnertype_select">
                            ...
                            <div class="mt-4">
                            <label>Company Status Type</label>
            ...
            <div class="col-sm col-md-6 col-lg-6 m-auto">
                ...
                $('#partnertype_select').on('change', function b() {
                    var partnertype_select = $(this).val();
                ...
                $.ajax({
                url:'<?=base_url();?>Menu/getcmpdbypstnst12',
                type: "POST",
                data: {
                pstid: pstid,
                // stid: stid,
                prtsl:partnertype_select,
                bdid: bdid,
                fdate: fdate,
